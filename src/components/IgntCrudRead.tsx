            ...
            {items.map((item: any) => (
              <div key={item.id} className="flex justify-between mb-6 items-start">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-400 font-semibold capitalize">{"id"}</div>
                  <div className="mb-3 text-base">{item["id"]}</div>
                  <div className="text-sm text-gray-400 font-semibold capitalize">{"body"}</div>
                  <div className="mb-3 text-base">{item["body"]}</div>
                  <div className="text-sm text-gray-400 font-semibold capitalize">{"title"}</div>
                  <div className="mb-3 text-base">{item["title"]}</div>
                  <div className="text-sm text-gray-400 font-semibold capitalize">{"creator"}</div>
                  <div className="mb-3 text-base">{item["creator"]}</div>
                  {/* 데이터 구조 바인딩 문제 */}
